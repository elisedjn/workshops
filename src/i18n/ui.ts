...
> = {
  en: {
    ...
    note:
      "Choose a location-based event or invite the workshop to your home for birthdays, holidays, family gatherings, and small group celebrations.",
    blogIntro:
  ...
  fr: {
    ...
    note:
      "Choisissez un événement local ou invitez l'atelier chez vous pour un anniversaire, des vacances, une réunion de famille ou un petit groupe.",
    blogIntro:
  ...
  pt: {
    ...
    note:
      "Escolha um evento local ou convide o workshop para sua casa em aniversários, férias, encontros de família e pequenas celebrações.",
    blogIntro:
...
> = {
  ericeira: {
    en: {
      ...
      title: "A creative pause between ocean walks and village life.",
      intro:
        "Join a small-group workshop in Ericeira with a calm rhythm, tactile materials, and a welcoming atmosphere for beginners.",
      accent: "blue",
      highlights: ["Small groups", "Beginner-friendly guidance", "Seasonal creative themes"],
      practical: ["Location: Ericeira", "Languages: English, French, Portuguese", "Format: public events or private groups"],
    },
    fr: {
      ...
      accent: "blue",
      highlights: ["Petits groupes", "Accessible aux débutants", "Thèmes créatifs de saison"],
      practical: ["Lieu : Ericeira", "Langues : anglais, français, portugais", "Format : événements publics ou groupes privés"],
    },
    pt: {
      ...
      accent: "blue",
      highlights: ["Pequenos grupos", "Adequado para iniciantes", "Temas criativos sazonais"],
      practical: ["Local: Ericeira", "Idiomas: inglês, francês, português", "Formato: eventos públicos ou grupos privados"],
    },
  },
  santaCruz: {
    en: {
      ...
      accent: "yellow",
      highlights: ["Coastal setting", "Flexible themes", "Great for families and holiday groups"],
      practical: ["Location: Santa Cruz", "Languages: English, French, Portuguese", "Format: seasonal events and private bookings"],
    },
    fr: {
      ...
      accent: "yellow",
      highlights: ["Cadre côtier", "Thèmes flexibles", "Idéal pour familles et groupes en vacances"],
      practical: ["Lieu : Santa Cruz", "Langues : anglais, français, portugais", "Format : événements saisonniers et réservations privées"],
    },
    pt: {
      ...
      accent: "yellow",
      highlights: ["Ambiente costeiro", "Temas flexíveis", "Ótimo para famílias e grupos de férias"],
      practical: ["Local: Santa Cruz", "Idiomas: inglês, francês, português", "Formato: eventos sazonais e reservas privadas"],
    },
  },
  atHome: {
    en: {
      ...
      accent: "pink",
      highlights: ["Private format", "Adapted to your group", "Materials can be brought to you"],
      practical: ["Location: your home or holiday rental", "Languages: English, French, Portuguese", "Format: private booking by request"],
    },
    fr: {
      ...
      accent: "pink",
      highlights: ["Format privé", "Adapté à votre groupe", "Le matériel peut venir à vous"],
      practical: ["Lieu : chez vous ou dans votre location", "Langues : anglais, français, portugais", "Format : réservation privée sur demande"],
    },
    pt: {
      ...
      accent: "pink",
      highlights: ["Formato privado", "Adaptado ao grupo", "Os materiais podem ir até si"],
      practical: ["Local: casa ou alojamento de férias", "Idiomas: inglês, francês, português", "Formato: reserva privada mediante pedido"],
    },
  },
};
